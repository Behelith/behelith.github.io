...
const About = props => {
    ...
    if (langContext.lang == 'pl') return (<div className='page fade-in'>
        <p className="page__watermark">O mnie</p>
        <p className="page__label">Cześć, jestem Adrian!</p>
        ...
        <p className="page__text">Niewdawno moją uwagę przykuł również backend i postanowiłem przyjrzeć się <a className="external-link" href="https://nodejs.org/en/" target='_blank'>Node.js</a></p>
    </div>)

    return (
        <div className='fade-in'>
            <p className="page__watermark">About</p>
            <p className="page__label">Hi, I'm Adrian!</p>

            <p className="page__text">My adventure as developer has started around 2017 and since then I'm discovering what JavaScript has to offer. Most of the time I've been working with vanilla JS because of flexibility of use it provided. Once I understood basics, I decided to look for some helpful frameworks. Similarily when it comes to CSS and HTML. I recommend <a className="external-link" href="https://reactjs.org/" target='_blank'>React</a> and <a className="external-link" href="https://www.w3schools.com/w3css/default.asp" target='_blank'>W3.CSS</a> for everyone. </p>

            <p className="page__text">Recently backend dev also caught my attention and I decided to try <a className="external-link" href="https://nodejs.org/en/" target='_blank'>Node.js</a></p>
        </div>)
}
